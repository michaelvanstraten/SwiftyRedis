...
extension RedisConnection {
    ...
    public func bgsave<T: FromRedisValue>(options: BgsaveOptions) async throws -> T {
        try await Cmd("BGSAVE").query(self)
    }
    ...
    public struct BitcountIndex: ToRedisArgs {
        let start: Int
        let end: Int
        let indexUnit: BitcountIndexIndexUnit
        public func write_redis_args(out: inout [Data]) {
            out.append("index".data(using: .utf8)!)
            start.write_redis_args(out: &out)
            end.write_redis_args(out: &out)
            indexUnit.write_redis_args(out: &out)
        }
    }
    public enum BitcountIndexIndexUnit: ToRedisArgs {
        case BYTE
        case BIT
        public func write_redis_args(out: inout [Data]) {
            switch self {
    ...
    public enum BitfieldOperation: ToRedisArgs {
        case GET(BitfieldOperationEncodingOffset)
        case Write(BitfieldOperationWrite)
        public func write_redis_args(out: inout [Data]) {
            switch self {
            case .GET(let bitfieldoperationencodingoffset): bitfieldoperationencodingoffset.write_redis_args(out: &out)
            case .Write(let bitfieldoperationwrite): bitfieldoperationwrite.write_redis_args(out: &out)
            }
        }
    }
    public struct BitfieldOperationEncodingOffset: ToRedisArgs {
        let encoding: String
        let offset: Int
        public func write_redis_args(out: inout [Data]) {
    ...
    public struct BitfieldOperationWrite: ToRedisArgs {
        let OVERFLOW: BitfieldOperationWriteWrapSatFail
        let writeOperation: BitfieldOperationWriteWriteOperation
        public func write_redis_args(out: inout [Data]) {
            out.append("write".data(using: .utf8)!)
            OVERFLOW.write_redis_args(out: &out)
            writeOperation.write_redis_args(out: &out)
        }
    }
    public enum BitfieldOperationWriteWrapSatFail: ToRedisArgs {
        case WRAP
        case SAT
        case FAIL
        public func write_redis_args(out: inout [Data]) {
    ...
    public enum BitfieldOperationWriteWriteOperation: ToRedisArgs {
        case SET(BitfieldOperationWriteWriteOperationEncodingOffsetValue)
        case INCRBY(BitfieldOperationWriteWriteOperationEncodingOffsetIncrement)
        public func write_redis_args(out: inout [Data]) {
            switch self {
            case .SET(let bitfieldoperationwritewriteoperationencodingoffsetvalue):
                bitfieldoperationwritewriteoperationencodingoffsetvalue.write_redis_args(out: &out)
            case .INCRBY(let bitfieldoperationwritewriteoperationencodingoffsetincrement):
                bitfieldoperationwritewriteoperationencodingoffsetincrement.write_redis_args(out: &out)
            }
        }
    }
    public struct BitfieldOperationWriteWriteOperationEncodingOffsetValue: ToRedisArgs {
        let encoding: String
        let offset: Int
        let value: Int
        public func write_redis_args(out: inout [Data]) {
    ...
    public struct BitfieldOperationWriteWriteOperationEncodingOffsetIncrement: ToRedisArgs {
        let encoding: String
        let offset: Int
        let increment: Int
        public func write_redis_args(out: inout [Data]) {
    ...
    public struct BitposIndex: ToRedisArgs {
        let start: Int
        let endIndex: BitposIndexEndIndex
        public func write_redis_args(out: inout [Data]) {
            out.append("index".data(using: .utf8)!)
            start.write_redis_args(out: &out)
    ...
    public struct BitposIndexEndIndex: ToRedisArgs {
        let end: Int
        let indexUnit: BitposIndexEndIndexIndexUnit
        public func write_redis_args(out: inout [Data]) {
            out.append("end_index".data(using: .utf8)!)
            end.write_redis_args(out: &out)
            indexUnit.write_redis_args(out: &out)
        }
    }
    public enum BitposIndexEndIndexIndexUnit: ToRedisArgs {
        case BYTE
        case BIT
        public func write_redis_args(out: inout [Data]) {
            switch self {
    ...
    public func copy<T: FromRedisValue>(
        source: String, destination: String, destinationDb: Int? = nil, options: CopyOptions
    ) async throws -> T {
    ...
    public func eval<T: FromRedisValue>(script: String, numkeys: Int, key: String?..., arg: String?...) async throws
        -> T
    {
    ...
    public func evalsha<T: FromRedisValue>(sha1: String, numkeys: Int, key: String?..., arg: String?...) async throws
        -> T
    {
    ...
    public struct GeoaddLongitudeLatitudeMember: ToRedisArgs {
        ...
        let member: String
        public func write_redis_args(out: inout [Data]) {
            out.append("longitude_latitude_member".data(using: .utf8)!)
    ...
    public struct GeoaddOptions: OptionSet, ToRedisArgs {
        public let rawValue: Int
        public init(rawValue: Int) { self.rawValue = rawValue }
        static let CHANGE = GeoaddOptions(rawValue: 1 << 0)
        public func write_redis_args(out: inout [Data]) {
            if self.contains(.CHANGE) { out.append("CHANGE".data(using: .utf8)!) }
        }
    }
    ...
    public enum GetexExpiration: ToRedisArgs {
        ...
        public func write_redis_args(out: inout [Data]) {
            switch self {
            case .EX(let int): int.write_redis_args(out: &out)
            case .PX(let int): int.write_redis_args(out: &out)
            case .EXAT(let int64): int64.write_redis_args(out: &out)
            case .PXAT(let int64): int64.write_redis_args(out: &out)
    ...
    public struct HelloArguments: ToRedisArgs {
        let protover: Int
        let AUTH: HelloArgumentsUsernamePassword
        let SETNAME: String
        public func write_redis_args(out: inout [Data]) {
            out.append("arguments".data(using: .utf8)!)
            protover.write_redis_args(out: &out)
            AUTH.write_redis_args(out: &out)
            SETNAME.write_redis_args(out: &out)
        }
    }
    public struct HelloArgumentsUsernamePassword: ToRedisArgs {
        let username: String
        let password: String
        public func write_redis_args(out: inout [Data]) {
    ...
    public struct HmsetFieldValue: ToRedisArgs {
        ...
        let value: String
        public func write_redis_args(out: inout [Data]) {
            out.append("field_value".data(using: .utf8)!)
    ...
    public func lcs<T: FromRedisValue>(key1: String, key2: String, len: Int? = nil, options: LcsOptions) async throws
        -> T
    { try await Cmd("LCS").arg(key1.to_redis_args()).arg(key2.to_redis_args()).arg(len.to_redis_args()).query(self) }
    ...
    public struct MsetKeyValue: ToRedisArgs {
        ...
        let value: String
        public func write_redis_args(out: inout [Data]) {
            out.append("key_value".data(using: .utf8)!)
    ...
    public struct PsubscribePattern: ToRedisArgs {
        ...
        public func write_redis_args(out: inout [Data]) {
            ...
            pattern.write_redis_args(out: &out)
        }
    }
    ...
    public func restore<T: FromRedisValue>(
        ...
        try await Cmd("RESTORE").arg(key.to_redis_args()).arg(ttl.to_redis_args()).arg(serializedValue.to_redis_args())
            .arg(seconds.to_redis_args()).arg(frequency.to_redis_args()).query(self)
    }
    ...
    public func shutdown<T: FromRedisValue>(nosaveSave: ShutdownNosaveSave? = nil, options: ShutdownOptions)
        async throws -> T
    { try await Cmd("SHUTDOWN").arg(nosaveSave.to_redis_args()).query(self) }
    ...
    public func sintercard<T: FromRedisValue>(numkeys: Int, key: String..., limit: Int? = nil) async throws -> T {
        try await Cmd("SINTERCARD").arg(numkeys.to_redis_args()).arg(key.to_redis_args()).arg(limit.to_redis_args())
            .query(self)
    }
    ...
    public func sort<T: FromRedisValue>(
        ...
        order: SortOrder? = nil, destination: String? = nil, options: SortOptions
    ) async throws -> T {
        try await Cmd("SORT").arg(key.to_redis_args()).arg(pattern.to_redis_args()).arg(offsetCount.to_redis_args())
            .arg(GET.to_redis_args()).arg(order.to_redis_args()).arg(destination.to_redis_args()).query(self)
    }
    ...
    public struct SortOptions: OptionSet, ToRedisArgs {
        public let rawValue: Int
        public init(rawValue: Int) { self.rawValue = rawValue }
        static let SORTING = SortOptions(rawValue: 1 << 0)
        public func write_redis_args(out: inout [Data]) {
            if self.contains(.SORTING) { out.append("SORTING".data(using: .utf8)!) }
        }
    }
    ...
    public func sort_ro<T: FromRedisValue>(
        ...
        order: SortRoOrder? = nil, options: SortRoOptions
    ) async throws -> T {
        try await Cmd("SORT_RO").arg(key.to_redis_args()).arg(pattern.to_redis_args()).arg(offsetCount.to_redis_args())
            .arg(GET.to_redis_args()).arg(order.to_redis_args()).query(self)
    }
    ...
    public struct SortRoOptions: OptionSet, ToRedisArgs {
        public let rawValue: Int
        public init(rawValue: Int) { self.rawValue = rawValue }
        static let SORTING = SortRoOptions(rawValue: 1 << 0)
        public func write_redis_args(out: inout [Data]) {
            if self.contains(.SORTING) { out.append("SORTING".data(using: .utf8)!) }
        }
    }
    ...
    public func xautoclaim<T: FromRedisValue>(
        ...
        try await Cmd("XAUTOCLAIM").arg(key.to_redis_args()).arg(group.to_redis_args()).arg(consumer.to_redis_args())
            .arg(minIdleTime.to_redis_args()).arg(start.to_redis_args()).arg(count.to_redis_args()).query(self)
    }
    ...
    public func xclaim<T: FromRedisValue>(
        ...
        unixTimeMilliseconds: Int64? = nil, count: Int? = nil, options: XclaimOptions
    ) async throws -> T {
        ...
        ).arg(id.to_redis_args()).arg(ms.to_redis_args()).arg(unixTimeMilliseconds.to_redis_args()).arg(
            count.to_redis_args()
        ).query(self)
    }
    ...
    public struct XpendingFilters: ToRedisArgs {
        ...
        let consumer: String
        public func write_redis_args(out: inout [Data]) {
            out.append("filters".data(using: .utf8)!)
            IDLE.write_redis_args(out: &out)
            start.write_redis_args(out: &out)
            end.write_redis_args(out: &out)
            count.write_redis_args(out: &out)
    ...
    public struct XreadStreams: ToRedisArgs {
        ...
        let id: String
        public func write_redis_args(out: inout [Data]) {
            out.append("STREAMS".data(using: .utf8)!)
            key.write_redis_args(out: &out)
    ...
    public func xreadgroup<T: FromRedisValue>(
        ...
        ).arg(streams.to_redis_args()).query(self)
    }
    public struct XreadgroupGroupConsumer: ToRedisArgs {
        let group: String
        let consumer: String
        public func write_redis_args(out: inout [Data]) {
            out.append("GROUP".data(using: .utf8)!)
    ...
    public struct ZaddScoreMember: ToRedisArgs {
        ...
        let member: String
        public func write_redis_args(out: inout [Data]) {
            out.append("score_member".data(using: .utf8)!)
    ...
    public struct ZaddOptions: OptionSet, ToRedisArgs {
        public let rawValue: Int
        public init(rawValue: Int) { self.rawValue = rawValue }
        static let CHANGE = ZaddOptions(rawValue: 1 << 0)
        static let INCREMENT = ZaddOptions(rawValue: 1 << 1)
        public func write_redis_args(out: inout [Data]) {
            if self.contains(.CHANGE) { out.append("CHANGE".data(using: .utf8)!) }
            if self.contains(.INCREMENT) { out.append("INCREMENT".data(using: .utf8)!) }
        }
    }
    ...
    public func zdiff<T: FromRedisValue>(numkeys: Int, key: String..., options: ZdiffOptions) async throws -> T {
        try await Cmd("ZDIFF").arg(numkeys.to_redis_args()).arg(key.to_redis_args()).query(self)
    }
    ...
    public func zinter<T: FromRedisValue>(
        numkeys: Int, key: String..., weight: Int?..., aggregate: ZinterAggregate? = nil, options: ZinterOptions
    ) async throws -> T {
        try await Cmd("ZINTER").arg(numkeys.to_redis_args()).arg(key.to_redis_args()).arg(weight.to_redis_args()).arg(
    ...
    public func zintercard<T: FromRedisValue>(numkeys: Int, key: String..., limit: Int? = nil) async throws -> T {
        try await Cmd("ZINTERCARD").arg(numkeys.to_redis_args()).arg(key.to_redis_args()).arg(limit.to_redis_args())
            .query(self)
    }
    ...
    public func zinterstore<T: FromRedisValue>(
        ...
        try await Cmd("ZINTERSTORE").arg(destination.to_redis_args()).arg(numkeys.to_redis_args()).arg(
            key.to_redis_args()
        ).arg(weight.to_redis_args()).arg(aggregate.to_redis_args()).query(self)
    }
    ...
    public func zrangestore<T: FromRedisValue>(
        ...
        offsetCount: ZrangestoreOffsetCount? = nil, options: ZrangestoreOptions
    ) async throws -> T {
        try await Cmd("ZRANGESTORE").arg(dst.to_redis_args()).arg(src.to_redis_args()).arg(min.to_redis_args()).arg(
            max.to_redis_args()
        ).arg(sortby.to_redis_args()).arg(offsetCount.to_redis_args()).query(self)
    }
    ...
    public func zrevrange<T: FromRedisValue>(key: String, start: Int, stop: Int, options: ZrevrangeOptions) async throws
        -> T
    {
        try await Cmd("ZREVRANGE").arg(key.to_redis_args()).arg(start.to_redis_args()).arg(stop.to_redis_args()).query(
            self)
    }
    ...
    public func zrevrangebyscore<T: FromRedisValue>(
        ...
        options: ZrevrangebyscoreOptions
    ) async throws -> T {
    ...
    public func zunion<T: FromRedisValue>(
        numkeys: Int, key: String..., weight: Int?..., aggregate: ZunionAggregate? = nil, options: ZunionOptions
    ) async throws -> T {
        try await Cmd("ZUNION").arg(numkeys.to_redis_args()).arg(key.to_redis_args()).arg(weight.to_redis_args()).arg(
            aggregate.to_redis_args()
        ).query(self)
    }
