...
extension RedisConnection {
    ...
    public func function_list<T: FromRedisValue>(libraryNamePattern: String? = nil, options: FunctionListOptions)
        async throws -> T
    { try await Cmd("FUNCTION").arg("LIST").arg(libraryNamePattern.to_redis_args()).query(self) }
    ...
    public func function_load<T: FromRedisValue>(functionCode: String, options: FunctionLoadOptions) async throws -> T {
        try await Cmd("FUNCTION").arg("LOAD").arg(functionCode.to_redis_args()).query(self)
    }
